...
async function resolve(opts) {
    ...
    return {
        ...
        version: (_a = version === null || version === void 0 ? void 0 : version.version) !== null && _a !== void 0 ? _a : '*',
        artifact: path_1.default.basename(download.archive.url),
        debug: false,
        enterprise: download.edition === 'enterprise',
        branch: 'master',
        bits: ['i386', 'i686'].includes(download.arch) ? '32' : '64',
        ext: (_c = (_b = download.archive.url.match(/\.([^.]+)$/)) === null || _b === void 0 ? void 0 : _b[1]) !== null && _c !== void 0 ? _c : 'tgz'
    };
}
